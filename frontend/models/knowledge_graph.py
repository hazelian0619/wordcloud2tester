...
class handler(BaseHTTPRequestHandler):
    ...
    def _send_error(self, message: str, status_code: int = 400):
        ...
        self.wfile.write(json.dumps(error_response, ensure_ascii=False).encode('utf-8'))</content>
<parameter name="filePath">/workspaces/wordcloud2tester/api/v2/path-expand.py